...
class P4ReaderWindow(ReaderWindow):
    def __init__(self, parent_window: Window | None):
        super().__init__(parent_window)

        self.input_exp_cnt.setText("20")
        self.input_step.setText("4")
    ...
    def read_info(self):
        ...
        if self.check_1.isChecked():
            write(1, 4, exp_cnt, 6, step, left, right, grid_id)
        if self.check_2.isChecked():
            write(2, 4, exp_cnt, 6, step, left, right, grid_id)
