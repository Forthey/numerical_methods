...
class EvaluateIntegralStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Evaluate = channel.stream_stream(
                ...
                request_serializer=grpc__files_dot_main__pb2.Requirements.SerializeToString,
                response_deserializer=grpc__files_dot_main__pb2.Integral.FromString,
                )
...
def add_EvaluateIntegralServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Evaluate': grpc.stream_stream_rpc_method_handler(
                    servicer.Evaluate,
                    request_deserializer=grpc__files_dot_main__pb2.Requirements.FromString,
                    response_serializer=grpc__files_dot_main__pb2.Integral.SerializeToString,
            ),
    }
...
class EvaluateIntegral(object):
    ...
    def Evaluate(request_iterator,
        ...
        return grpc.experimental.stream_stream(request_iterator, target, '/nm.EvaluateIntegral/Evaluate',
            grpc__files_dot_main__pb2.Requirements.SerializeToString,
            grpc__files_dot_main__pb2.Integral.FromString,
